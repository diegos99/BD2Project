...
@Component({
  selector: 'app-venta2-list',
  templateUrl: './venta2-list.component.html',
  styleUrls: ['./venta2-list.component.css']
})
export class Venta2ListComponent implements OnInit {
  ...
  @ViewChild("content", { static: false }) content: ElementRef;
    ...
    reloadData() {
      this.detalleFactura = this.employeeService.getVentas2List();
    }
